...
import { IProfileResponse, ISearchByUsernameResponse } from './messages/i-profile';
...
export async function getUserProfileByUsername(username: string): Promise<ISearchByUsernameResponse | {error : unknown}> {
