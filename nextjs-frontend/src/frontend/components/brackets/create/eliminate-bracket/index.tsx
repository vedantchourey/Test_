...
const EliminateBracket: React.FC<EliminateBracketProps> = ({
  ...
  const validationSchema = yup.object({
    ...
    startTime: yup
      ...
      .nullable()
      .transform((v) => (v instanceof Date && !isNaN(v.getTime()) ? v : null)),
    checkInType: yup.string(),
    checkInAmount: yup.number().required("Minutes are required"),
    type: yup.string().required("type is required"),
    thirdPlace: yup.boolean(),
        ...
        <Grid container rowSpacing={1} columnSpacing={5}>
            ...
            {formik.values.checkInType === "true" ? (
              <React.Fragment>
                ...
                <OutlinedInput
                  id="checkInAmount"
                  placeholder="Minutes"
                  onChange={(val:any): void => changeHandler("checkInAmount", val)}
                  ...
                  <FormControlLabel
                    ...
                    control={
                      <Checkbox
                        ...
                        onChange={(event): void =>
                          changeHandler("thirdPlace", event.target.value)
                        }
                      />
                    }
          ...
          <Grid item xs={6}>
            <FormControl fullWidth>
              ...
              {
                formik.touched.playersLimit && Boolean(formik.errors.playersLimit) ?(
