...
function validateEmail(details: Partial<ResetPasswordRequest>): string | undefined {
...
function validatePassword(obj: Partial<NewPasswordRequest>): string | undefined {
...
function validateConfirmPassword(obj: Partial<NewPasswordRequest>): string | undefined {
  if (isNullOrEmpty(obj.confirm_password)) return 'Is required';
  if (obj.password !== obj.confirm_password) return "Password didn't match";
}

function validatePhoneNumber(details: Partial<ResetPasswordRequest>): string | undefined {
