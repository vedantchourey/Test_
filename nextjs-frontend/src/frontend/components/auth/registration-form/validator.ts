...
function validateStateId(details: Partial<SignupRequest>): string | undefined {
  if (details.stateId == null) return 'Is required';
}

function validateCountry(details: Partial<SignupRequest>): string | undefined {
...
function validateEmail(details: Partial<SignupRequest>): string | undefined {
...
function validateUserName(details: Partial<SignupRequest>): string | undefined {
