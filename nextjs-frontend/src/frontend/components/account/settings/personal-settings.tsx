...
import { Autocomplete, Button, Divider, FormLabel, Grid, TextField, Typography } from "@mui/material";
  ...
  return (
    <>
      ...
      <Box sx={{ textAlign: 'right', mt: 4 }}>
        <Button className={styles.actionButton} ><Typography>Save Changes</Typography></Button>
      </Box>
    </>
  );
};
