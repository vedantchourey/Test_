    ...
    <Box className={styles.otherProfileCard}>
      <Box className={styles.profileSection}>
        <Box sx={{ position: 'relative' }}>
          <Avatar sx={{ width: 85, height: 85, marginBottom: 2 }} alt="Remy Sharp" src="/static/images/avatar/1.jpg" />
        ...
        <Box sx={{ display: "flex", flexDirection: 'column', mt: 8 }}>
          <Button startIcon={<PersonAddAltIcon />} sx={{
            background: '#6931F9', padding: "8px 64px", mb: 2
          }} variant='contained'>
            Follow
          </Button>
          <Button sx={{ padding: "8px 64px" }} variant='outlined'>
            Message
          </Button>
        </Box>
      </Box>
