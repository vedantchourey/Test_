import GameMapResponse from '../service-clients/games-service/game-map-response';
import {v4 as uuidv4} from 'uuid';
import UpdateGameMapRequest from '../service-clients/games-service/update-game-map-request';
