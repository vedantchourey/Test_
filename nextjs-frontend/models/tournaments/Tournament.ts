import {TournamentRequest} from '../../service-clients/tournament-service/TournamentRequest';
import {getTimeAsLocal, parseToLocalJSDate, setDate, setTime} from '../../utils/DateTimeUtils';
import {Time} from '../../components/common/noob-time/NoobTime';
import {TournamentValidator, tournamentValidator} from './TournamentValidator';
