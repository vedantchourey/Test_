...
import { deletePlayerFromWatchList } from "../../../src/backend/services/FreeAgencyMarket/FreeAgencyMarket-Service";
...
export default createNextJsRouteHandler({
  post: {
    handler: async (
      ...
      const result = await deletePlayerFromWatchList(req.body, context);
