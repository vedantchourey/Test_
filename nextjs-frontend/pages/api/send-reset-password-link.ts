...
import { ResetPasswordRequest } from '../../src/backend/services/auth-service/reset-password/i-reset-password';
...
export default createNextJsRouteHandler({
    post: {
      handler: async (req: NextApiRequest, res: NextApiResponse<ServiceResponse<ResetPasswordRequest, object>>,  context: PerRequestContext) => {
