...
import { getListOfInvitations } from "../../../src/backend/services/team-service";
...
export default createNextJsRouteHandler({
    get: {
        handler: async (
            ...
            const result: any = await getListOfInvitations(context.transaction as Knex.Transaction, context.user as any);
