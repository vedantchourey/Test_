          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "row" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                <Typography variant="body2" color={"white"}>Noobstorm is a community for gamers, by gamers. From cross-platform tournaments to active recruiting – we’re creating an opportunity for you to go pro. </Typography>
                <Typography variant="body2" color={"white"}>Noobstorm was born out of devotion. Gaming gave us our best childhood memories – and we want to share that passion with you.</Typography>
                <Typography variant="body2" color={"white"}>We designed Noobstorm to be the world’s #1 e-sports platform. More than just tournament hosting, we want to give you opportunities to grow, interact, and succeed. </Typography>
                <Typography variant="body2" color={"white"}>And, of course, have some fun while you’re going pro.</Typography>
              </div>
            </div>
          </div>
        )}
